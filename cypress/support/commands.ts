...
Cypress.Commands.add('addUser', function(id, firstName, lastName, userName, email, age) {
    ...
    cy.get('input-editor input[ng-reflect-name="id"]').type(id, {delay: 10});
    cy.get('input-editor input[ng-reflect-name="firstName"]').type(firstName, {delay: 10});
    cy.get('input-editor input[ng-reflect-name="lastName"]').type(lastName, {delay: 10});
    cy.get('input-editor input[ng-reflect-name="username"]').type(userName, {delay: 10});
    cy.get('input-editor input[ng-reflect-name="email"]').type(email, {delay: 10});
    cy.get('input-editor input[ng-reflect-name="age"]').type(age, {delay: 10});
